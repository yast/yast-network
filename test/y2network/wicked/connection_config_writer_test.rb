...
describe Y2Network::Wicked::ConnectionConfigWriter do
  ...
  describe "#write" do
    let(:handler) do
      instance_double(
        Y2Network::Wicked::ConnectionConfigWriters::Ethernet,
        write: nil
      )
    end
    ...
    before do
      ...
      allow(Y2Network::Wicked::ConnectionConfigWriters::Ethernet).to receive(:new)
        .and_return(handler)
