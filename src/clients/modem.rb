...
module Yast
  class ModemClient < Client
    def main
      ...
      Builtins.y2milestone("Modem module started")

      Yast.import "GetInstArgs"
      Yast.import "Mode"
      Yast.import "CommandLine"

      Yast.include self, "network/modem/wizards.rb"
      ...
      # Finish
      Builtins.y2milestone("Modem module finished")
      Builtins.y2milestone("----------------------------------------")
      deep_copy(@ret) 
